...
namespace BannersAndNotification.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IBannerActionMasterService, BannerActionMasterService>();
            services.AddTransient<IBannersService, BannersService>();
            services.AddTransient<INotificationStatusCaptureService, NotificationStatusCaptureService>();
