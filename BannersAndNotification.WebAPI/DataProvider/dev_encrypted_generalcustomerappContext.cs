...
namespace BannersAndNotification.WebAPI.DataProvider
{
    public partial class dev_encrypted_generalcustomerappContext : DbContext
    {
        ...
        [DbFunction("ToBoolean")]
        public static bool ToBoolean(int? Id)
        {
         if(Id>0)
            {
                return true;
        ...
        //[DbFunction("TruncateTime", "dbo")]
        //public static double? TruncateTime(DateTime? DateValue)
        //{
        //    if (DateValue == null)
        //    {
        //        return null;
        ...
        //        return ((TimeSpan)(epoch - DateValue.Value.Date)).Seconds;
        //    }
        //}
