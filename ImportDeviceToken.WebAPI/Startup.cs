...
using ImportDeviceToken.WebAPI.Helpers;

namespace ImportDeviceToken.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IImportDeviceTokenService, ImportDeviceTokenService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=ImportDeviceToken}/{action=devicetoken}/{id?}");
            });
