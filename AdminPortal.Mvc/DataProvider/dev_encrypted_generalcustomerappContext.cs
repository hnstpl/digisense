...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySQL("server=192.168.1.101;port=3306;user=udhayakumarm;password=Pwd08uk2020;database=dev_encrypted_generalcustomerapp");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblTpdhModelSpecificationMappingLang>(entity =>
            {
                ...
                entity.HasOne(d => d.IdNavigation)
                    .WithOne(p => p.TblTpdhModelSpecificationMappingLang)
                    .HasForeignKey<TblTpdhModelSpecificationMappingLang>(d => d.Id)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("tbl_tpdh_model_specification_mapping_lang_ibfk_1");
