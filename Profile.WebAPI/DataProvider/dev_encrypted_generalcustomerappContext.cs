...
namespace Profile.WebAPI.DataProvider
{
    public partial class dev_encrypted_generalcustomerappContext : DbContext
    {
        ...
        [DbFunction("DiffSeconds")]
        public static double DiffSeconds(DateTime? FromDateTime, DateTime? ToDateTime)
        {
            ...
            {
                return ((TimeSpan)(ToDateTime - FromDateTime)).Seconds;
            }
        ...
        public virtual DbSet<MstMandiCropListMapping> MstMandiCropListMapping { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MstDealerbranchhierarchy>(entity =>
            {
                ...
                entity.Property(e => e.IsImplementsVc)
                    .HasColumnName("isImplements_VC")
                    .HasMaxLength(5)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<MstMandiCropListMapping>(entity =>
            {
                entity.ToTable("mst_mandi_crop_list_mapping", "dev_encrypted_generalcustomerapp");

                entity.HasIndex(e => e.Id)
                    .HasName("ID");

                entity.HasIndex(e => e.MandiCropName)
                    .HasName("Mandi_CropName");
                ...
                entity.Property(e => e.MandiCropName)
                    .IsRequired()
                    .HasColumnName("Mandi_CropName")
                    .HasMaxLength(40)
                    .IsUnicode(false);
