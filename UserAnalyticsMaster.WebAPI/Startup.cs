...
using UserAnalyticsMaster.WebAPI.Helpers;
using UserAnalyticsMaster.WebAPI.Services;

namespace UserAnalyticsMaster.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IUserAnalyticsMasterService, UserAnalyticsMasterService>();
            services.AddTransient<IUserAnalyticsService, UserAnalyticsService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=UserAnalyticsMaster}/{action=Get_UserAnalyticsMdules}/{id?}");
            });
